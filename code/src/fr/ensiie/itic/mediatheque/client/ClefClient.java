 ...
 * retrouver rapidement les clients dans une table de hachage.
 * Ces attributs sont le nom, et le prenom du client.
 */
public final class ClefClient implements java.io.Serializable {
    /** serial number.	 */
     ...
     */
    public ClefClient(final String n, final String p) {
        this.nom = n;
        this.prenom = p;
    }
    @Override
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof ClefClient)) {
            return false;
        }
        ClefClient hc = (ClefClient) obj;
